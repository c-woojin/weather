...
def get_weather_summary_messages(location: Location, repo: AbstractWeatherSummaryRepository) -> Dict[str, str]:
    weather_summary = repo.get_weather_summary(location, message_strategy="default")
